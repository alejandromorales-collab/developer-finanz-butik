import { PaintBrush, UsersThree, FileText, SignOut } from "@phosphor-icons/react";
...
const items = [
  { title: "Clients", url: "/manager", icon: UsersThree },
  { title: "Brand Settings", url: "/manager/brand", icon: PaintBrush },
